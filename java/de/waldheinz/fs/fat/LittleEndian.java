...
public final class LittleEndian {
     ...
     */
    public static byte getUInt8(byte[] src, int offset) {
        return (byte)(src[offset] & 0xFF);
    }
     ...
     * @param offset
     */
    public static short getUInt16(byte[] src, int offset) {
        final short v0 = (short)(src[offset + 0] & 0xFF);
        final short v1 = (short)(src[offset + 1] & 0xFF);
    ...
    public static int getUInt32(byte[] src, int offset) {
        ...
        int v2 = (src[offset + 2] & 0xFF);
        int v3 = (src[offset + 3] & 0xFF);
